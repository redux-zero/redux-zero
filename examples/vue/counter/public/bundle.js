...
function connect(component, store, mapToProps, actions) {
    ...
    var bound = bindActions(actions, store);
...
var mapToProps = function (ref) {
  var count = ref.count;

  return ({ count: count });
};

var Counter = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_vm._v(_vm._s(_vm.count))]),_vm._v(" "),_c('div',[_c('button',{staticClass:"button",on:{"click":function($event){_vm.increment();}}},[_vm._v("+")]),_vm._v(" "),_c('button',{staticClass:"button",on:{"click":function($event){_vm.decrement();}}},[_vm._v("-")])])])},staticRenderFns: [],
  data: function data () {
    return {
      count: 0
    }
  ...
  created: function created() {
    vue_1(this, this.$store, mapToProps, actions);
  },
};
...
var store = reduxZero(initialState);

Vue$3.prototype.$store = store;
